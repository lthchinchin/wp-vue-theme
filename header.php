            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-top-wrap">
                        <div class="company">CÔNG TY TNHH SẮT THÉP QUANG HUY PHÁT</div>
                        <div class="contact">
                            <div class="icon-box d-flex align-items-center"><i class="far fa-envelope"></i></div>
                            <a href="mailto:quanghuyphat@gmail.com">quanghuyphat@gmail.com</a>
                            <div class="separate"></div>
                            <div class="icon-box d-flex align-items-center"><i class="far fa-clock"></i></div>
                            <span>08:00 - 18:00</span>
                            <div class="separate d-lg-block d-none"></div>
                            <ul class="social list-unstyled mb-0 d-lg-flex d-none">
                                <li>
